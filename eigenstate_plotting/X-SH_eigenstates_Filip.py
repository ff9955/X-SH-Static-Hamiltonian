...
def build_CT_block(state_list, coord_vector, connectivity, interaction_constant, donor_coupling, acceptor_coupling, e_potential):
    ...
    interaction between charge carriers, coupling magnitude between charge carriers, e_potential = electrocehmical
    ...
    e_potential = e_potential*1000*single_lattice_distance*2 # conversion of electric field from V per angstrom
